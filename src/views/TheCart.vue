    ...
    <div class="order-summary-block">
        ...
        <div class="summary-total">
            ...
            <p style="font-weight:normal">Tổng tiền: 
                <span total-final>1,593,000₫</span>
            </p>
        </div>
        ...
        <div class="order-summary-block order-summary-notify">
            <div class="summary-warning alert-order">
                <p class="textmr">
                    <strong>TokyoLife nhận ship đơn hàng trị giá từ 150K. Hy vọng quý khách hàng có những trải nghiệm tốt nhất khi mua sắm tại website TokyoLife. Xin cảm ơn!</strong>
                </p>
                <p>
