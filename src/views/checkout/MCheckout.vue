<template>
  ...
  <m-pop-up :isShow="true" minWidth="600px" minHeight="400px">
    <template #header>
    ...
    <div class="address-customer">
        ...
        <div class="body-address">
            <div class="i-f-address">nguyen avan duogn <span>0328669614</span></div>
            <div class="i-f-address-detail">Cty Tnhh Changchun Vina, lô b, Đường D 1, Cụm Cn An Ngãi</div>
    ...
    <template #footer>
      ...
      <div class="m-f-bw">
        <div @click="isPopUpDelete = false">
          <m-button typeBtn="close">Hủy</m-button>
        </div>
        <div>
          <m-button backgroundColor="red">Cập nhật</m-button>
        </div>
      </div>
    </template>
  </m-pop-up>
