<template>
  ...
  >
    <div class="order-status">
      ...
      <div
        class="status-item"
        :class="tabActive == enumStatus.ChoThanhToan ? 'active' : ''"
        @click="changeTab(enumStatus.ChoThanhToan)"
      >
        Chờ thanh toán
      </div>
      <div
        class="status-item"
        :class="tabActive == enumStatus.VanChuyen ? 'active' : ''"
        @click="changeTab(enumStatus.VanChuyen)"
      >
        Vận chuyển
      </div>
      <div
