  ...
  <div class="product-item">
    ...
    <div class="item-content">
      <div class="product-title">
        Áo Polo Nữ Dura Cổ Bo Dệt Tổ Ong I9POL010K
      </div>
      <div class="product-brand">
        Thương hiệu: <span>{{ "TOKYOBASIC" }}</span>
      </div>
      <div class="product-price">
        <div class="product-price-old">350,000₫</div>
        <div class="product-price-new">249,000₫</div>
      </div>
      <div class="product-color">
        <div class="product-color-title">
          Màu sắc: <br /><strong> Ghi nhạt </strong>
        </div>
      ...
      <div class="product-size">
        ...
        <div class="product-size-list">
          <div class="product-size-item" v-for="index in 4" :key="index">M</div>
        </div>
      </div>
      <hr />
