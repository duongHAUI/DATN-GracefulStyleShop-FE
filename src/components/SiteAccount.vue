        ...
        <div class="site_account_panel_list">
            <div class="login-panel" :style="{display : loginLayout ? 'block' : 'none'}">
                ...
                <div class="site_account_inner">
                    <m-input id="email" placeholder="Email" v-model="formLogin.Email" textField="Email"  />
                    <m-input id="password" placeholder="Mật khẩu" type="password" v-model="formLogin.Password" textField="Mật khẩu" marginTop="12px" />
